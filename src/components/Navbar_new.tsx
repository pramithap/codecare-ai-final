...
const Navbar = () => {
  ...
  // Show public nav while loading to prevent hydration mismatch
  const navItems = loading ? publicNavItems : (session ? authenticatedNavItems : publicNavItems);
                    ...
                    <>
                      ...
                      >
                        <div className="p-2">
                          ...
                          <button
                            className="flex items-center space-x-2 w-full px-3 py-2 text-sm text-slate-200 hover:text-white hover:bg-slate-700/50 rounded-lg transition-all duration-200 mt-1"
                            onClick={() => {
                              setMenuOpen(false);
                              signOut();
                            }}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-slate-800/50 backdrop-blur-sm border-t border-white/10 rounded-b-xl mt-2">
              ...
              {session && (
                <button
                  ...
                  className="flex items-center space-x-3 px-4 py-3 rounded-xl text-base font-medium text-blue-100/80 hover:text-white hover:bg-white/10 transition-all duration-300 w-full"
                >
